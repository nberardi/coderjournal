...
namespace CoderJournal.Modules.Journal.Data
{
	...
	public partial class Journal : ITable<Guid?>
	{
			...
			try
			{
				...
				using(SqlDataReader reader = command.ExecuteReader())
				{
					if (reader.HasRows)
					{
						...
						order[1] = reader.GetOrdinal("UrlName");
						order[2] = reader.GetOrdinal("Title");
						order[3] = reader.GetOrdinal("Summary");
						order[4] = reader.GetOrdinal("Updated");
						order[5] = reader.GetOrdinal("Published");
						order[6] = reader.GetOrdinal("Content");

						while (reader.Read()) 
						{
							Journal entity = new Journal();
							entity._journalID = reader.IsDBNull(0) ? (Guid?)null :  reader.GetGuid(order[0]); // JournalID
							entity._urlName = reader.IsDBNull(1) ? String.Empty :  reader.GetString(order[1]); // UrlName
							entity._title = reader.IsDBNull(2) ? String.Empty :  reader.GetString(order[2]); // Title
							entity._summary = reader.IsDBNull(3) ? String.Empty :  reader.GetString(order[3]); // Summary
							entity._updated = reader.IsDBNull(4) ? (DateTime)SqlDateTime.MinValue :  reader.GetDateTime(order[4]); // Updated
							entity._published = reader.IsDBNull(5) ? (DateTime)SqlDateTime.MinValue :  reader.GetDateTime(order[5]); // Published
							entity._content = reader.IsDBNull(6) ? String.Empty :  reader.GetString(order[6]); // Content
			...
			try
			{
				...
				using(SqlDataReader reader = command.ExecuteReader())
				{
					if (reader.HasRows)
					{
						...
						entity._urlName = reader.IsDBNull(1) ? String.Empty :  reader.GetString(reader.GetOrdinal("UrlName"));
						entity._title = reader.IsDBNull(2) ? String.Empty :  reader.GetString(reader.GetOrdinal("Title"));
						entity._summary = reader.IsDBNull(3) ? String.Empty :  reader.GetString(reader.GetOrdinal("Summary"));
						entity._updated = reader.IsDBNull(4) ? (DateTime)SqlDateTime.MinValue :  reader.GetDateTime(reader.GetOrdinal("Updated"));
						entity._published = reader.IsDBNull(5) ? (DateTime)SqlDateTime.MinValue :  reader.GetDateTime(reader.GetOrdinal("Published"));
						entity._content = reader.IsDBNull(6) ? String.Empty :  reader.GetString(reader.GetOrdinal("Content"));
		...
		protected static bool InsertOrUpdate (Guid? journalID, string urlName, string title, string summary, DateTime updated, DateTime published, string content)		
		{
			using(SqlConnection connection = new SqlConnection(ConfigurationManager.ConnectionStrings["ManagedFusion"].ConnectionString))
			{
				using (SqlCommand command = connection.CreateCommand())
				{
					command.CommandText = "Journal_Journal";
		...
		public static bool Insert (Guid? journalID, string urlName, string title, string summary, DateTime updated, DateTime published, string content)
		{
		...
		public static bool Update (Guid? journalID, string urlName, string title, string summary, DateTime updated, DateTime published, string content)
		{
			return InsertOrUpdate(
				journalID,
				urlName,
		...
		public static bool Delete (Guid? journalID)
		{
			using(SqlConnection connection = new SqlConnection(ConfigurationManager.ConnectionStrings["ManagedFusion"].ConnectionString))
			{
				using (SqlCommand command = connection.CreateCommand())
				{
					command.CommandText = "Journal_Journal_Delete";
					command.CommandType = CommandType.StoredProcedure;
		...
		/// Column Published : 
		/// </summary>
		private DateTime _published = (DateTime)SqlDateTime.MinValue;
		...
		public Journal (Guid? journalID, string urlName, string title, string summary, DateTime updated, DateTime published, string content)
		{
		...
		/// <summary>Gets or sets the UrlName value for the column.</summary>
		/// <remarks></remarks>
