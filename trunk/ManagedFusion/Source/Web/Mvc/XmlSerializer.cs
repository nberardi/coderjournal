...
namespace ManagedFusion.Web.Mvc
{
	...
	/// 
	/// </summary>
	internal class XmlSerializer : ManagedFusion.Serialization.XmlSerializer
	{
		...
		{
			Dictionary<string, object> response = ServiceViewEngine.BuildResponse(_serializableObject, serialization);
