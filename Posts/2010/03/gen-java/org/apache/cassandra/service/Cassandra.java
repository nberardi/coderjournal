...
public class Cassandra {
  ...
  public static class multiget_result implements TBase<multiget_result._Fields>, java.io.Serializable, Cloneable, Comparable<multiget_result>   {
  ...
  public static class multiget_slice_result implements TBase<multiget_slice_result._Fields>, java.io.Serializable, Cloneable, Comparable<multiget_slice_result>   {
  ...
  public static class batch_insert_args implements TBase<batch_insert_args._Fields>, java.io.Serializable, Cloneable, Comparable<batch_insert_args>   {
    ...
    public int compareTo(batch_insert_args other) {
      ...
      if (isSetCfmap()) {        lastComparison = TBaseHelper.compareTo(cfmap, typedOther.cfmap);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
  ...
  public static class describe_keyspace_result implements TBase<describe_keyspace_result._Fields>, java.io.Serializable, Cloneable, Comparable<describe_keyspace_result>   {
